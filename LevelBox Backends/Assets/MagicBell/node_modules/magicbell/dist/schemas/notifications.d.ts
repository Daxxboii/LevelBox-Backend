export declare const CreateNotificationsResponseSchema: {
    readonly title: "CreateNotificationsResponseSchema";
    ...
    readonly required: readonly ["id", "title", "sent_at"];
};
export declare const CreateNotificationsPayloadSchema: {
    readonly title: "CreateNotificationsPayloadSchema";
    readonly type: "object";
    readonly additionalProperties: false;
    readonly properties: {
        readonly title: {
        ...
        readonly recipients: {
            readonly description: "Users to send the notification to. You can specify up to 1000 users at once. Use matches to send a notification to everyone.";
            readonly nullable: false;
            readonly minItems: 1;
            ...
            readonly items: {
                ...
                readonly properties: {
                    ...
                    readonly external_id: {
                        readonly type: "string";
                        readonly description: "A unique string that MagicBell can utilize to uniquely identify the user. We recommend setting this attribute to the ID of the user in your database. Provide the external id if the user's email is unavailable.";
                        readonly nullable: true;
                    };
                    readonly matches: {
                        readonly type: "string";
